...
if [[ -f "$script_dir/../VERSION" ]]; then
  ...
  export RLDYOUR_ANTIGRAVITY_ADAPTER_VERSION="1.7.3"
fi
...
version = os.environ.get("RLDYOUR_ANTIGRAVITY_ADAPTER_VERSION", "1.7.3")
message = (
    f"rldyour-antigravity-cli adapter={version} runtime=antigravity-cli@1.0.12; "
