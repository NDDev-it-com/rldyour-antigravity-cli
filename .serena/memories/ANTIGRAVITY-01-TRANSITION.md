...
Scope: ANTIGRAVITY repository knowledge
Area: ANTIGRAVITY
-->
...
## Purpose
Maintain durable Antigravity CLI adapter knowledge for `ANTIGRAVITY-01-TRANSITION`.
...
## Scope
ANTIGRAVITY repository knowledge
...
## Facts
- ANTIGRAVITY facts are derived from current repository evidence.
