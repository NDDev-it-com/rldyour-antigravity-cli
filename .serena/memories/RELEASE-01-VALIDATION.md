...
- checked by: Antigravity adapter 1.7.29 release validation

## Facts
- Current adapter release version is `1.7.29`; `VERSION`, `pyproject.toml`,
...
- Antigravity CLI remains pinned to `1.1.0`; this adapter release changes the
