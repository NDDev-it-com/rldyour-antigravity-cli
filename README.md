...
| Surface | Value |
| --- | ---: |
| Adapter version | `1.7.9` |
| Runtime baseline | Antigravity CLI `1.0.13` |
| Runtime channel | `stable/curl-latest` |
| GitHub release tag | `1.7.9` |
...
Antigravity CLI adapter `1.7.9` targets enterprise, paid API-key, Vertex AI, Google
