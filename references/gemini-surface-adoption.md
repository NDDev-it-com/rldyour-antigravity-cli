...
The adapter targets Antigravity CLI (`agy`) `1.0.13` and adopts native Antigravity CLI
...
Antigravity built-in `browser_agent` is intentionally disabled in `1.7.11`; browser
