...
The adapter targets Antigravity CLI (`agy`) `1.0.16` and adopts native Antigravity CLI
...
Antigravity built-in `browser_agent` is intentionally disabled in `1.7.16`; browser
